...
public class Constants {
    public Constants(){}
    // Root page
    public static String WEBAPP_URL = "https://afriteachweb.herokuapp.com";
    public static String WEBAPP_HOST = "https://afriteachweb.herokuapp.com"; // used for checking Intent-URLs
